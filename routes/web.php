...
Route::get('recipes/{id}/verrecipes', 'RecipesController@verrecipes');
...
Route::get('/recipes/{id}/cambiarstatusrecipe', 'RecipesController@cambiarstatusrecipe');
Route::put('/recipes/{id}/statusrecipe', 'RecipesController@statusrecipe');
